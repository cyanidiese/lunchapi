...
// 2018-08-22 16:28:29.530099897 +0300 EEST m=+0.969910863
...
var doc = `{
    ...
    "basePath": "/",
    "paths": {
        "/admin/history/{from_date}/to/{to_date}": {
            "get": {
                "security": [
                    {
                        "Authorization": []
        ...
        "/user/provider/{provider_id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Provider ID to set",
                        "name": "provider_id",
                        "in": "path",
                        "required": true
                    }
